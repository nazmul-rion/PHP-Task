...
if (isset($_POST['edit-profile'])) {
    ...
    if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] !== $_SESSION['csrf_token']) {
        die("Token mismatch" . $_POST['csrf_token'] . " Seasion : " . $_SESSION['csrf_token']);
    } else {
        // CSRF token is valid, process the form data.

        $newUsername = mysqli_real_escape_string($con, htmlspecialchars($_POST['username']));
        $newEmail = mysqli_real_escape_string($con, ($_POST['email']));
        $oldPassword = mysqli_real_escape_string($con, $_POST['oldPassword']);
        $newPassword = mysqli_real_escape_string($con, $_POST['newPassword']);
        $rNewPassword = mysqli_real_escape_string($con, $_POST['rNewPassword']);
